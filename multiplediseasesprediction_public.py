...
#print("heloooo my path is",script_dir)
script_dir = os.path.dirname(os.path.abspath(__file__))

# Load the model file using the script directory and file name
model_path = os.path.join(script_dir, 'heart_disease_prediction_model.sav')
...
#heart_disease_model=pickle.load(open(os.path.dirname(__file__)+'\heart_disease_prediction_model.sav','rb'))
#diabetes_disease_model=pickle.load(open(os.path.dirname(__file__)+'\diabetes_model2.sav','rb'))
#breastcancer_model=pickle.load(open(os.path.dirname(__file__)+'\breastcancer_modelnew.sav','rb'))
