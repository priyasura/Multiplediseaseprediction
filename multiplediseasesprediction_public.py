...
model_path = os.path.join(script_dir, 'diabetes_model2.sav')
if not os.path.exists(model_path):
    print(f"Model file not found: {model_path}")
else:
    with open(model_path, 'rb') as file:
       diabetes_disease_model = pickle.load(file) 

model_path = os.path.join(script_dir, 'breastcancer_modelnew.sav')
if not os.path.exists(model_path):
    print(f"Model file not found: {model_path}")
else:
    with open(model_path, 'rb') as file:
